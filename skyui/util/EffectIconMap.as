...
class skyui.util.EffectIconMap
{
	...
	[
		...
		"dispel",									// 2 - ARCHETYPE_DISPEL											OK
		"cure",										// 3 - ARCHETYPE_CUREDISEASE								OK
		null,											// 4 - ARCHETYPE_ABSORB											EMBLEM
		null,											// 5 - ARCHETYPE_DUALVALUEMOD								EMBLEM
		"calm",										// 6 - ARCHETYPE_CALM												OK
		"demoralize",							// 7 - ARCHETYPE_DEMORALIZE									OK
		"frenzy",									// 8 - ARCHETYPE_FRENZY											OK
		...
		"open",										// 16 - ARCHETYPE_OPEN											OK
		"bound_item",							// 17 - ARCHETYPE_BOUNDWEAPON								OK
		"conjure",								// 18 - ARCHETYPE_SUMMONCREATURE						OK
		"detect_life",						// 19 - ARCHETYPE_DETECTLIFE								OK
		"telekinesis",						// 20 - ARCHETYPE_TELEKINESIS								OK
		"paralysis",							// 21 - ARCHETYPE_PARALYSIS									OK
		"reanimate",							// 22 - ARCHETYPE_REANIMATE									OK
		"soul_trap",							// 23 - ARCHETYPE_SOULTRAP									OK
		"demoralize",							// 24 - ARCHETYPE_TURNUNDEAD								OK
		"clairvoyance",						// 25 - ARCHETYPE_GUIDE											OK
		null,											// 26 - ARCHETYPE_WEREWOLFFEED							nn
		"cure",										// 27 - ARCHETYPE_CUREPARALYSIS							OK
		"cure",										// 28 - ARCHETYPE_CUREADDICTION							OK
		"cure",										// 29 - ARCHETYPE_CUREPOISON								OK
	...
	private static var _avMap: Array = [
		...
		"av_inventoryweight",			// 31 - AV_INVENTORYWEIGHT									OK
		"av_carryweight",					// 32 - AV_CARRYWEIGHT											OK
		"av_crit_chance",					// 33 - AV_CRITCHANCE												OK
		"av_damage_melee",				// 34 - AV_MELEEDAMAGE											OK
		...
		"detect_life",						// 56 - AV_DETECTLIFERANGE									OK
		...
		"av_ward",								// 67 - AV_WARDDEFLECTION										OK
		...
		null,											// 114 - AV_ONEHANDEDSKILLADVANCE						nn
		"av_att_strength",				// 115 - AV_TWOHANDEDSKILLADVANCE						OK
		null,											// 116 - AV_MARKSMANSKILLADVANCE						nn
		null,											// 117 - AV_BLOCKSKILLADVANCE								nn
		null,											// 118 - AV_SMITHINGSKILLADVANCE						nn
		"av_att_endurance",				// 119 - AV_HEAVYARMORSKILLADVANCE					OK
		"av_att_speed",						// 120 - AV_LIGHTARMORSKILLADVANCE					OK
		"av_att_luck",						// 121 - AV_PICKPOCKETSKILLADVANCE					OK
		null,											// 122 - AV_LOCKPICKINGSKILLADVANCE					nn
		"av_att_agility",					// 123 - AV_SNEAKSKILLADVANCE								OK
		null,											// 124 - AV_ALCHEMYSKILLADVANCE							nn
		"av_att_personality",			// 125 - AV_SPEECHCRAFTSKILLADVANCE					OK
		null,											// 126 - AV_ALTERATIONSKILLADVANCE					nn
		null,											// 127 - AV_CONJURATIONSKILLADVANCE					nn
		"av_att_intelligence",		// 128 - AV_DESTRUCTIONSKILLADVANCE					OK
		null,											// 129 - AV_ILLUSIONSKILLADVANCE						nn
		null,											// 130 - AV_RESTORATIONSKILLADVANCE					nn
		"av_att_willpower",				// 131 - AV_ENCHANTINGSKILLADVANCE					OK
		"av_weapon_speed",				// 132 - AV_LEFTWEAPONSPEEDMULT							OK
		...
		"av_damage_melee",				// 154 - AV_ATTACKDAMAGEMULT								OK
		...
		"av_damage_reflect"				// 163 - AV_REFLECTDAMAGE										OK
	];
