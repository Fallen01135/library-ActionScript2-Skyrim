class Shared.CenteredScrollingList extends Shared.BSScrollingList
{
   ...
   function UpdateList()
   {
      ...
      {
         var _loc5_ = this.GetClipByIndex(_loc4_);
      ...
      if(!this.bDisableInput)
      {
         ...
         while(_loc2_ && _loc2_ != undefined)
         {
            if(_loc2_ == this)
            {
               if(delta < 0)
               {
                  var _loc4_ = this.GetClipByIndex(this.iNumTopHalfEntries + 1);
   ...
   function SetEntry(aEntryClip, aEntryObject)
   {
      if(aEntryClip != undefined)
      {
         ...
         else
         {
            ...
            {
               aEntryClip._alpha = 60 - _loc4_ * (this.iNumTopHalfEntries - aEntryClip.clipIndex);
            }
            else if(aEntryClip.clipIndex > this.iNumTopHalfEntries)
            {
               aEntryClip._alpha = 60 - _loc4_ * (aEntryClip.clipIndex - this.iNumTopHalfEntries);
            }
            else
            {
         ...
         if(aEntryObject.showIcon == false)
         {
            aEntryClip.statusIcon._visible = false;
         }
         else
         {
            aEntryClip.statusIcon._visible = true;
         }
