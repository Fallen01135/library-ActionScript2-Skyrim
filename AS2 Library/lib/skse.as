intrinsic class skse
{
	...
	static function SetClipboardData(text: String): Void;

	static function GetModList(): Object;

	static function GetPlayerSex(): Number;
	static function RequestActorValues(formID: Number, inArray: Array, outArray: Array): Void;
}